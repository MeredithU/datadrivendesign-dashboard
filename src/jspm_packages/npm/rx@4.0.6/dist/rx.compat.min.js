...
(function(process) {
  (function(a) {
    ...
    function l(a) {
      ...
      if (!Za(a))
        return b;
      Ya.nonEnumArgs && a.length && $a(a) && (a = ab.call(a));
      var c = Ya.enumPrototypes && "function" == typeof a,
          d = Ya.enumErrorProps && (a === Sa || a instanceof Error);
      for (var e in a)
        c && "prototype" == e || d && ("message" == e || "name" == e) || b.push(e);
      if (Ya.nonEnumShadows && a !== Ta) {
        var f = a.constructor,
            g = -1,
            h = Ea;
        if (a === (f && f.prototype))
    ...
    function p(a, b, c, d) {
      ...
      var i = g == Ga;
      if (!i) {
        if (g != Ma || !Ya.nodeClass && (o(a) || o(b)))
          return !1;
        var j = !Ya.argsObject && $a(a) ? Object : a.constructor,
            k = !Ya.argsObject && $a(b) ? Object : b.constructor;
        if (!(j == k || Qa.call(a, "constructor") && Qa.call(b, "constructor") || ja(j) && j instanceof j && ja(k) && k instanceof k || !("constructor" in a && "constructor" in b)))
          return !1;
      }
      c || (c = []), d || (d = []);
    ...
    function D(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && A(b) ? (b = C(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > tc ? tc : b) : b;
    }
    function E(a, b) {
    ...
    var U = {
      ...
      object: !0
        ...
        ea = ba.helpers.defaultNow = function() {
    ...
    ra.prototype = Object.create(Error.prototype), ra.prototype.name = "EmptyError";
    var sa = ba.ObjectDisposedError = function() {
      this.message = "Object has been disposed", Error.call(this);
    };
    sa.prototype = Object.create(Error.prototype), sa.prototype.name = "ObjectDisposedError";
    var ta = ba.ArgumentOutOfRangeError = function() {
      this.message = "Argument out of range", Error.call(this);
    };
    ta.prototype = Object.create(Error.prototype), ta.prototype.name = "ArgumentOutOfRangeError";
    var ua = ba.NotSupportedError = function(a) {
      this.message = a || "This operation is not supported", Error.call(this);
    };
    ua.prototype = Object.create(Error.prototype), ua.prototype.name = "NotSupportedError";
    var va = ba.NotImplementedError = function(a) {
      this.message = a || "This operation is not implemented", Error.call(this);
    };
    va.prototype = Object.create(Error.prototype), va.prototype.name = "NotImplementedError";
    ...
    aa.Set && "function" == typeof(new aa.Set)["@@iterator"] && (xa = "@@iterator");
    ...
    !function() {
      ...
      for (c in arguments)
        ;
      Ya.enumErrorProps = Va.call(Sa, "message") || Va.call(Sa, "name"), Ya.enumPrototypes = Va.call(a, "prototype"), Ya.nonEnumArgs = 0 != c, Ya.nonEnumShadows = !/valueOf/.test(b);
    }(1);
    var Za = ba.internals.isObject = function(a) {
      var b = typeof a;
    ...
    Array.prototype.every || (Array.prototype.every = function(a) {
      var b = Object(this),
          c = fb && Pa.call(this) === Oa ? this.split("") : b,
          d = c.length >>> 0,
          e = arguments[1];
      if (Pa.call(a) !== Ka)
        throw new TypeError(a + " is not a function");
    ...
    }()), aa.Element && aa.Element.prototype.attachEvent && !aa.Element.prototype.addEventListener && function() {
      function a(a, b) {
      ...
      }), b.interval = setInterval(b, 1), aa.addEventListener("load", b);
    }(), (!aa.CustomEvent || "object" == typeof aa.CustomEvent) && function() {
      function b(b, c) {
        var d;
        c = c || {
          bubbles: !1,
      ...
      aa.CustomEvent && (b.prototype = aa.CustomEvent.prototype), aa.CustomEvent = b;
    }();
    var gb = ba.CompositeDisposable = function() {
      var a,
          b,
          c = [];
    ...
    var ib = ba.Disposable = function(a) {
    ...
    var jb = ib.create = function(a) {
      return new ib(a);
        ...
        nb = ib._fixup = function(a) {
          return lb(a) ? a : kb;
        },
        ob = ba.SingleAssignmentDisposable = function() {
    ...
    var pb = ba.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    ...
    var qb = ba.BinaryDisposable = function(a, b) {
    ...
    var rb = ba.NAryDisposable = function(a) {
    ...
    var sb = ba.RefCountDisposable = function() {
      function a(a) {
    ...
    var tb = ba.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || ga, this.disposable = new ob;
    };
    tb.prototype.invoke = function() {
      ...
      return nb(this.action(this.scheduler, this.state));
    };
    var ub = ba.Scheduler = function() {
      function a() {}
    ...
    !function(a) {
      function b(a, b) {
        function c(b) {
          function d(a, b) {
            return g ? f.remove(i) : h = !0, e(b, c), kb;
          }
          var g = !1,
              h = !1,
              i = a.schedule(b, d);
      ...
      function c(a, b) {
        function c(b, d) {
          function g(a, b) {
            return h ? f.remove(j) : i = !0, e(b, c), kb;
          }
          var h = !1,
              i = !1,
      ...
      ub.prototype.schedulePeriodic = function(a, b, c) {
        if ("undefined" == typeof aa.setInterval)
          throw new ua;
        b = vb(b);
        var d = a,
    ...
    var xb,
        yb,
        zb = (ba.internals.SchedulePeriodicRecursive = function() {
          function a(a) {
            return function(b, c) {
              c(0, a._period);
              var d = la(a._action)(a._state);
              d === ka && (a._cancel.dispose(), e(d.e)), a._state = d;
            };
          }
          function b(a, b, c, d) {
        ...
        Bb = function(a) {
          ...
          var d;
          return bb(c, a), c.prototype.schedule = function(a, c) {
            var f = new tb(this, a, c, this.now());
            if (d)
              d.enqueue(f);
            else {
              d = new Jb(4), d.enqueue(f);
              var g = la(b)();
              d = null, g === ka && e(g.e);
            }
            return f.disposable;
        ...
        Cb = ub.currentThread = new Bb,
        Db = function() {
          var a,
              b = ca;
          if (aa.setTimeout)
            a = aa.setTimeout, b = aa.clearTimeout;
          else {
            if (!aa.WScript)
              throw new ua;
            a = function(a, b) {
    ...
    !function() {
      ...
      function b() {
        if (!aa.postMessage || aa.importScripts)
          return !1;
        var a = !1,
            b = aa.onmessage;
        return aa.onmessage = function() {
          a = !0;
      ...
      var g = new RegExp("^" + String(Pa).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
          h = "function" == typeof(h = X && $ && X.setImmediate) && !g.test(h) && h;
      if (ja(h))
        xb = function(b) {
          var e = c++;
        ...
        aa.addEventListener("message", j, !1), xb = function(a) {
          var b = c++;
          return d[b] = a, aa.postMessage(i + currentId, "*"), b;
        };
      } else if (aa.MessageChannel) {
        var k = new aa.MessageChannel;
        ...
        xb = "document" in aa && "onreadystatechange" in aa.document.createElement("script") ? function(b) {
    ...
    var Gb = function(a) {
      ...
      function c(a, b, c, d) {
        return function() {
          !a.isDisposed && a.setDisposable(ib._fixup(b(c, d)));
        };
      }
      function d(a, b) {
      ...
      return bb(b, a), d.prototype.dispose = function() {
        ...
        var e = new ob,
            f = xb(c(e, b, this, a));
        return new qb(e, new d(yb, f));
      }, b.prototype._scheduleFuture = function(a, b, e) {
        if (0 === b)
          return this.schedule(a, e);
        var f = new ob,
            g = Eb(c(f, e, this, a), b);
        return new qb(f, new d(Fb, g));
      }, b;
    }(ub),
        Hb = ub["default"] = ub.async = new Gb,
        Ib = function(a) {
          function b(b, c) {
          ...
          return bb(b, a), b.prototype.schedule = function(a, b) {
            ...
            var b = this;
            return function(c, d) {
              var f = la(a)(b._getRecursiveWrapper(c), d);
              return f === ka ? (b._handler(f.e) || e(f.e), kb) : nb(ret);
            };
            ...
            return g.setDisposable(this._scheduler.schedulePeriodic(a, b, function(a) {
              if (f)
                return null;
              var b = la(c)(a);
              return b === ka ? (f = !0, d._handler(b.e) || e(b.e), g.dispose(), null) : ret;
            })), g;
          }, b;
        }(ub);
    u.prototype.compareTo = function(a) {
      var b = this.value.compareTo(a.value);
      return 0 === b && (b = this.id - a.id), b;
    };
    var Jb = ba.internals.PriorityQueue = function(a) {
    ...
    Kb.isHigherPriority = function(a, b) {
      ...
      var b = this.length++;
      this.items[b] = new u(Jb.count++, a), this.percolate(b);
    ...
    var Lb = ba.Notification = function() {
      function a() {}
      return a.prototype._accept = function(a, b, c) {
        ...
        var b = this;
        return wb(a) || (a = Ab), new Kd(function(c) {
        ...
        Pb = Lb.createOnNext = function(a) {
          return new Mb(a);
        },
        Qb = Lb.createOnError = function(a) {
          return new Nb(a);
        },
        Rb = Lb.createOnCompleted = function() {
          return new Ob;
        },
        Sb = ba.Observer = function() {};
    Sb.prototype.toNotifier = function() {
      var a = this;
      return function(b) {
        return b.accept(a);
      };
    }, Sb.prototype.asObserver = function() {
      var a = this;
    ...
    }, Sb.prototype.checked = function() {
      return new Xb(this);
    };
    var Tb = Sb.create = function(a, b, c) {
      return a || (a = ca), b || (b = ha), c || (c = ca), new Wb(a, b, c);
    };
    Sb.fromNotifier = function(a, b) {
      var c = Ca(a, b, 1);
      return new Wb(function(a) {
        return c(Pb(a));
      }, function(a) {
        return c(Qb(a));
      }, function() {
    ...
    }, Sb.prototype.notifyOn = function(a) {
      return new Zb(a, this);
    }, Sb.prototype.makeSafe = function(a) {
      return new AnonymousSafeObserver(this._onNext, this._onError, this._onCompleted, a);
    };
    var Ub,
        Vb = ba.internals.AbstractObserver = function(a) {
          function b() {
            this.isStopped = !1;
          }
        ...
        Wb = ba.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Xb = function(a) {
          ...
          return c.onNext = function(a) {
            this.checkAccess();
            var b = la(this._observer.onNext).call(this._observer, a);
            this._state = 0, b === ka && e(b.e);
          }, c.onError = function(a) {
            this.checkAccess();
            var b = la(this._observer.onError).call(this._observer, a);
            this._state = 2, b === ka && e(b.e);
          }, c.onCompleted = function() {
            this.checkAccess();
            var a = la(this._observer.onCompleted).call(this._observer);
            this._state = 2, a === ka && e(a.e);
        ...
        Yb = ba.internals.ScheduledObserver = function(a) {
          function b(b, c) {
            a.call(this), this.scheduler = b, this.observer = c, this.isAcquired = !1, this.hasFaulted = !1, this.queue = [], this.disposable = new pb;
          }
          return bb(b, a), b.prototype.next = function(a) {
            var b = this;
            ...
            !this.hasFaulted && this.queue.length > 0 && (a = !this.isAcquired, this.isAcquired = !0), a && this.disposable.setDisposable(this.scheduler.scheduleRecursive(this, function(a, b) {
              ...
              c = a.queue.shift();
              var d = la(c)();
              return d === ka ? (a.queue = [], a.hasFaulted = !0, e(d.e)) : void b(a);
            }));
          }, b.prototype.dispose = function() {
        ...
        $b = ba.Observable = function() {
          ...
          return Ub = b.prototype, b.isObservable = function(a) {
            return a && ja(a.subscribe);
          }, Ub.subscribe = Ub.forEach = function(a, b, c) {
            return this._subscribe("object" == typeof a ? a : Tb(a, b, c));
          }, Ub.subscribeOnNext = function(a, b) {
            return this._subscribe(Tb("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Ub.subscribeOnError = function(a, b) {
            return this._subscribe(Tb(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Ub.subscribeOnCompleted = function(a, b) {
            return this._subscribe(Tb(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, b;
        }(),
        _b = ba.ObservableBase = function(a) {
          function b(a) {
            return a && ja(a.dispose) ? a : ja(a) ? jb(a) : kb;
          }
          function c(a, c) {
            var d = c[0],
                f = c[1],
                g = la(f.subscribeCore).call(f, d);
            g !== ka || d.fail(ka.e) || e(ka.e), d.setDisposable(b(g));
          }
          function d() {
            a.call(this);
          }
          return bb(d, a), d.prototype._subscribe = function(a) {
            var b = new Ld(a),
                d = [b, this];
            return Cb.scheduleRequired() ? Cb.schedule(d, c) : c(null, d), b;
          }, d.prototype.subscribeCore = wa, d;
        }($b),
        ac = ba.FlatMapObservable = function(a) {
          function b(b, c, d, e) {
          ...
          function c(a, b, c, d) {
            this.i = 0, this.selector = b, this.resultSelector = c, this.source = d, this.o = a, Vb.call(this);
          }
          ...
          }, bb(c, Vb), c.prototype._wrapResult = function(a, b, c) {
            return this.resultSelector ? a.map(function(a, d) {
              return this.resultSelector(b, a, c, d);
            }, this) : a;
          }, c.prototype.next = function(a) {
            var b = this.i++,
                c = la(this.selector)(a, b, this.source);
            return c === ka ? this.o.onError(c.e) : (ia(c) && (c = lc(c)), (Aa(c) || za(c)) && (c = $b.from(c)), void this.o.onNext(this._wrapResult(c, a, b)));
        ...
        bc = ba.internals.Enumerable = function() {};
    ...
    var cc = function(a) {
      ...
      function c(a, b, c) {
        this._o = a, this._s = b, this._e = c, Vb.call(this);
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        var b = {isDisposed: !1},
            d = new pb,
            e = Cb.scheduleRecursive(this.sources[xa](), function(e, f) {
              if (!b.isDisposed) {
                var g = la(e.next).call(e);
                if (g === ka)
        ...
        return new rb([d, e, new v(b)]);
      }, bb(c, Vb), c.prototype.onNext = function(a) {
        this._o.onNext(a);
    ...
    var dc = function(a) {
      ...
      function c(a, b) {
        this._o = a, this._recurse = b, Vb.call(this);
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        var b = this.sources[xa](),
            d = {isDisposed: !1},
            e = new pb,
            f = Cb.scheduleRecursive(null, function(f, g) {
              if (!d.isDisposed) {
                var h = la(b.next).call(b);
                if (h === ka)
        ...
        return new rb([e, f, new v(d)]);
      }, bb(c, Vb), c.prototype.next = function(a) {
        this._o.onNext(a);
      }, c.prototype.error = function(a) {
        this._recurse(a);
    ...
    bc.prototype.catchError = function() {
      ...
      return new Kd(function(c) {
        var d,
            ...
            j = {isDisposed: !1},
            k = new pb,
            l = Cb.scheduleRecursive(null, function(a, b) {
              if (!j.isDisposed) {
                var g = la(i.next).call(i);
                if (g === ka)
                ...
                var l = new ob,
                    m = new ob;
                k.setDisposable(new qb(m, l)), l.setDisposable(h.subscribe(function(a) {
                  c.onNext(a);
                }, function(a) {
    ...
    var ec = function(a) {
      ...
      return bb(b, a), b.prototype[xa] = function() {
        ...
        return 0 === this.l ? ya : (this.l > 0 && this.l--, {
          done: !1,
          value: this.v
        });
      }, b;
        ...
        ic = function(a) {
          ...
          return bb(b, a), b.prototype.subscribeCore = function(a) {
            return this.source.subscribe(new Zb(this._s, a));
          }, b;
        }(_b);
    Ub.observeOn = function(a) {
    ...
    var jc = function(a) {
      ...
      function c(a, b) {
        var c = b[0],
            d = b[1],
            e = b[2];
        d.setDisposable(new s(a, c.subscribe(e)));
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new ob,
            d = new pb;
    ...
    var kc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        lc = $b.fromPromise = function(a, b) {
          return b || (b = Hb), new kc(a, b);
        };
    Ub.toPromise = function(a) {
    ...
    var nc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        var b = la(this._f)();
        return b === ka ? Hc(b.e).subscribe(a) : (ia(b) && (b = lc(b)), b.subscribe(a));
      }, b;
    }(_b),
        oc = ($b.defer = function(a) {
          return new nc(a);
        }, function(a) {
          function b(b) {
          ...
          return bb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            var a = this.observer;
            return this.scheduler === Ab ? d(null, a) : this.scheduler.schedule(a, d);
          }, b;
        }(_b)),
        pc = new oc(Ab),
        qc = $b.empty = function(a) {
          return wb(a) || (a = Ab), a === Ab ? pc : new oc(a);
        },
        rc = function(a) {
          function b(b, c, d) {
        ...
        sc = function() {
          ...
          return a.prototype.run = function() {
            function a(a, b) {
              var f = la(c.next).call(c);
              if (f === ka)
                return d.onError(f.e);
              if (f.done)
                return d.onCompleted();
              var g = f.value;
              return ja(e) && (g = la(e)(g, a), g === ka) ? d.onError(g.e) : (d.onNext(g), void b(a + 1));
            }
    ...
    var uc = $b.from = function(a, b, c, d) {
      if (null == a)
    ...
    var wc = $b.fromArray = function(a, b) {
      return wb(b) || (b = Cb), new vc(a, b);
    },
        xc = function(a) {
          ...
          function c(a, b) {
            if (a._first)
              a._first = !1;
            else if (a._state = la(a._itrFn)(a._state), a._state === ka)
              return a._o.onError(a._state.e);
            var c = la(a._cndFn)(a._state);
            if (c === ka)
              return a._o.onError(c.e);
            if (c) {
              var d = la(a._resFn)(a._state);
              if (d === ka)
    ...
    $b.generate = function(a, b, c, d, e) {
      return wb(e) || (e = Cb), new xc(a, b, c, d, e);
    };
    var yc = function(a) {
      function b() {
        a.call(this);
    ...
    var Fc = function(a) {
      ...
      function d(a, b) {
        var c = b[0],
            d = b[1];
        return d.onNext(c), d.onCompleted(), kb;
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Gc = ($b["return"] = $b.just = function(a, b) {
          return wb(b) || (b = Ab), new Fc(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        Hc = $b["throw"] = function(a, b) {
          return wb(b) || (b = Ab), new Gc(a, b);
        },
        Ic = function(a) {
          function b(b, c) {
          ...
          return bb(b, a), b.prototype.subscribeCore = function(a) {
            var b = kb,
                c = la(this._resFn)();
            if (c === ka)
              return new qb(Hc(c.e).subscribe(a), b);
            c && (b = c);
            var d = la(this._obsFn)(c);
            return d === ka ? new qb(Hc(d.e).subscribe(a), b) : new qb(d.subscribe(a), b);
          }, b;
        }(_b);
    $b.using = function(a, b) {
      return new Ic(a, b);
    }, Ub.amb = function(a) {
      var b = this;
      return new Kd(function(c) {
    ...
    var Jc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new ob,
            c = new pb;
        return c.setDisposable(b), b.setDisposable(this.source.subscribe(new Kc(a, c, this._fn))), c;
      }, b;
    }(_b),
        Kc = function(a) {
          function b(b, c, d) {
    ...
    Ub["catch"] = function(a) {
      return ja(a) ? new Jc(this, a) : Lc([this, a]);
    };
    var Lc = $b["catch"] = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        for (var b = this._params.length,
          ...
          var f = this._params[e],
              g = new ob;
          c[e] = g, ia(f) && (f = lc(f)), g.setDisposable(f.subscribe(new Nc(a, e, this._cb, d)));
        }
        return new rb(c);
      }, b;
    }(_b),
        Nc = function(a) {
          ...
          return bb(b, a), b.prototype.next = function(a) {
            if (this._state.values[this._i] = a, this._state.hasValue[this._i] = !0, this._state.hasValueAll || (this._state.hasValueAll = this._state.hasValue.every(da))) {
              var b = la(this._cb).apply(null, this._state.values);
              if (b === ka)
                return this._o.onError(b.e);
              this._o.onNext(b);
            } else
              this._state.isDone.filter(c(this._i)).every(da) && this._o.onCompleted();
          }, b.prototype.error = function(a) {
            this._o.onError(a);
          }, b.prototype.completed = function() {
        ...
        Oc = $b.combineLatest = function() {
          for (var a = arguments.length,
              b = new Array(a),
              c = 0; a > c; c++)
            b[c] = arguments[c];
          var d = ja(b[a - 1]) ? b.pop() : L;
          return Array.isArray(b[0]) && (b = b[0]), new Mc(b, d);
        };
    Ub.concat = function() {
      for (var a = [],
          b = 0,
    ...
    var Pc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = Ab.scheduleRecursive(0, function(f, g) {
              if (!a) {
                if (f === d)
        ...
        return new gb(b, f, jb(function() {
          a = !0;
        }));
      }, b;
    }(_b),
        Qc = $b.concat = function() {
          var a;
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Sc = function() {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new ob;
            this.g.add(c), ia(a) && (a = lc(a)), c.setDisposable(a.subscribe(new b(this, c)));
      ...
      return Array.isArray(c[0]) && (c = c[0]), G(a, c).mergeAll();
        ...
        Uc = function(a) {
          ...
          return bb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              var b = new ob;
              this.g.add(b), ia(a) && (a = lc(a)), b.setDisposable(a.subscribe(new d(this, b)));
            }
          }, c.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, c.prototype.onCompleted = function() {
    ...
    Ub.mergeAll = function() {
      return new Uc(this);
    };
    var Vc = ba.CompositeError = function(a) {
      this.innerErrors = a, this.message = "This contains multiple errors. Check the innerErrors", Error.call(this);
    };
    Vc.prototype = Object.create(Error.prototype), Vc.prototype.name = "CompositeError";
    var Wc = function(a) {
      function b(b) {
        this.source = b, a.call(this);
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        return b.add(c), c.setDisposable(this.source.subscribe(new Xc(b, d))), b;
      }, b;
    }(_b),
        Xc = function(a) {
          function b(b, c) {
          ...
          function c(a, b) {
            0 === b.length ? a.onCompleted() : 1 === b.length ? a.onError(b[0]) : a.onError(new Vc(b));
          }
          function d(b, c, d) {
          ...
          return bb(b, a), b.prototype.next = function(a) {
            var b = new ob;
            this._group.add(b), ia(a) && (a = lc(a)), b.setDisposable(a.subscribe(new d(b, this._group, this._state)));
          }, b.prototype.error = function(a) {
    ...
    $b.mergeDelayError = function() {
      ...
      var d = G(null, a);
      return new Wc(d);
    }, Ub.onErrorResumeNext = function(a) {
      if (!a)
    ...
    var Yc = function(a) {
      ...
      function c(a, b) {
        if (a.pos < a.sources.length) {
          ...
          ia(c) && (c = lc(c));
          var d = new ob;
          a.subscription.setDisposable(d), d.setDisposable(c.subscribe(new Zc(a, b)));
        } else
          a.o.onCompleted();
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        $c = $b.onErrorResumeNext = function() {
          var a = [];
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
        ...
        _c = function(a) {
          function b(b, c) {
            this._s = b, this._o = ia(c) ? lc(c) : c, this._open = !1, a.call(this);
          }
          return bb(b, a), b.prototype.subscribeCore = function(a) {
            var b = new ob;
            b.setDisposable(this._s.subscribe(new ad(a, this))), ia(this._o) && (this._o = lc(this._o));
            var c = new ob;
            return c.setDisposable(this._o.subscribe(new bd(a, this, c))), new qb(b, c);
          }, b;
        }(_b),
        ad = function(a) {
          function b(b, c) {
    ...
    var cd = function(a) {
      ...
      function c(a, b) {
        this.o = a, this.inner = b, this.stopped = !1, this.latest = 0, this.hasLatest = !1, Vb.call(this);
      }
      function d(a, b) {
        this.parent = a, this.id = b, Vb.call(this);
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new pb,
        ...
        var b = new ob,
            c = ++this.latest;
        this.hasLatest = !0, this.inner.setDisposable(b), ia(a) && (a = lc(a)), b.setDisposable(a.subscribe(new d(this, c)));
      }, c.prototype.error = function(a) {
        this.o.onError(a);
      }, c.prototype.completed = function() {
        this.stopped = !0, !this.hasLatest && this.o.onCompleted();
      }, bb(d, Vb), d.prototype.next = function(a) {
    ...
    Ub["switch"] = Ub.switchLatest = function() {
      return new cd(this);
    };
    var dd = function(a) {
      function b(b, c) {
        this.source = b, this.other = ia(c) ? lc(c) : c, a.call(this);
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        return new qb(this.source.subscribe(a), this.other.subscribe(new ed(a)));
      }, b;
    }(_b),
        ed = function(a) {
          function b(b) {
    ...
    var fd = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        for (var b = this._ss.length,
          ...
          var g = this._ss[f],
              h = new ob;
          ia(g) && (g = lc(g)), h.setDisposable(g.subscribe(new gd(a, f, c))), e[f] = h;
        }
        var h = new ob;
        return h.setDisposable(this._s.subscribe(new hd(a, this._cb, c))), e[d] = h, new rb(e);
      }, b;
    }(_b),
        gd = function(a) {
          function b(b, c, d) {
        ...
        hd = function(a) {
          ...
          return bb(b, a), b.prototype.next = function(a) {
            ...
            if (this._state.hasValueAll) {
              var c = la(this._cb).apply(null, b);
              return c === ka ? this._o.onError(c.e) : void this._o.onNext(c);
            }
          }, b.prototype.error = function(a) {
            this._o.onError(a);
          }, b.prototype.completed = function() {
    ...
    Ub.withLatestFrom = function() {
      ...
      for (var a = arguments.length,
        ...
        b[c] = arguments[c];
      var d = ja(b[a - 1]) ? b.pop() : L;
      return Array.isArray(b[0]) && (b = b[0]), new fd(this, b, d);
    };
    var id = function(a) {
      function b(b, c) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        for (var d = 0; b > d; d++) {
          var e = this._s[d],
              f = new ob;
          c[d] = f, ia(e) && (e = lc(e)), f.setDisposable(e.subscribe(new jd(a, d, this, q, done)));
        }
        return new rb(c);
      }, b;
    }(_b),
        jd = function(a) {
          ...
          return bb(b, a), b.prototype.next = function(a) {
            if (this._q[this._i].push(a), this._q.every(c)) {
              var b = this._q.map(d),
                  f = la(this._p._cb).apply(null, b);
              if (f === ka)
                return this._o.onError(f.e);
              this._o.onNext(f);
            } else
              this._d.filter(e(this._i)).every(da) && this._o.onCompleted();
          }, b.prototype.error = function(a) {
            this._o.onError(a);
          }, b.prototype.completed = function() {
    ...
    Ub.zip = function() {
      ...
      var e = this;
      return b.unshift(e), new id(b, d);
    }, $b.zip = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      Array.isArray(b[0]) && (b = ja(b[1]) ? b[0].concat(b[1]) : b[0]);
      var d = b.shift();
      return d.zip.apply(d, b);
    }, Ub.zipIterable = function() {
      if (0 === arguments.length)
        throw new Error("invalid arguments");
      for (var a = arguments.length,
          b = new Array(a),
      ...
      var d = ja(b[a - 1]) ? b.pop() : L,
          e = this;
      return b.unshift(e), new Kd(function(a) {
        for (var c = b.length,
            f = r(c, M),
            g = r(c, K),
            h = new Array(c),
          ...
          !function(c) {
            var i = b[c],
                j = new ob;
            (Aa(i) || za(i)) && (i = uc(i)), j.setDisposable(i.subscribe(function(b) {
    ...
    }, Ub.asObservable = function() {
      return new Kd(N(this), this);
    }, Ub.bufferWithCount = function(a, b) {
    ...
    var kd = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new ld(a));
      }, b;
    }(_b),
        ld = function(a) {
          function b(b) {
    ...
    var md = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new nd(a, this.keyFn, this.comparer));
      }, b;
    }(_b),
        nd = function(a) {
          function b(b, c, d) {
          ...
          return bb(b, a), b.prototype.next = function(a) {
            var b,
                c = a;
            return ja(this.keyFn) && (c = la(this.keyFn)(a), c === ka) ? this.o.onError(c.e) : this.hasCurrentKey && (b = la(this.comparer)(this.currentKey, c), b === ka) ? this.o.onError(b.e) : void(this.hasCurrentKey && b || (this.hasCurrentKey = !0, this.currentKey = c, this.o.onNext(a)));
          }, b.prototype.error = function(a) {
            this.o.onError(a);
          }, b.prototype.completed = function() {
            this.o.onCompleted();
    ...
    Ub.distinctUntilChanged = function(a, b) {
      return b || (b = fa), new md(this, a, b);
    };
    var od = function(a) {
      function b(b, c, d, e) {
      ...
      function c(a, b) {
        this.o = a, this.t = !b._oN || ja(b._oN) ? Tb(b._oN || ca, b._oE || ca, b._oC || ca) : b._oN, this.isStopped = !1, Vb.call(this);
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new c(a, this));
      }, bb(c, Vb), c.prototype.next = function(a) {
        var b = la(this.t.onNext).call(this.t, a);
        b === ka && this.o.onError(b.e), this.o.onNext(a);
      }, c.prototype.error = function(a) {
        var b = la(this.t.onError).call(this.t, a);
        return b === ka ? this.o.onError(b.e) : void this.o.onError(a);
      }, c.prototype.completed = function() {
        var a = la(this.t.onCompleted).call(this.t);
        return a === ka ? this.o.onError(a.e) : void this.o.onCompleted();
      }, b;
    }(_b);
    Ub["do"] = Ub.tap = Ub.doAction = function(a, b, c) {
      return new od(this, a, b, c);
    }, Ub.doOnNext = Ub.tapOnNext = function(a, b) {
      return this.tap("undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, Ub.doOnError = Ub.tapOnError = function(a, b) {
      return this.tap(ca, "undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, Ub.doOnCompleted = Ub.tapOnCompleted = function(a, b) {
      return this.tap(ca, null, "undefined" != typeof b ? function() {
        a.call(b);
      } : a);
    }, Ub["finally"] = function(a) {
      var b = this;
      return new Kd(function(c) {
        var d = la(b.subscribe).call(b, c);
        return d === ka ? (a(), e(d.e)) : jb(function() {
          var b = la(d.dispose).call(d);
          a(), b === ka && e(b.e);
        });
      }, this);
    };
    ...
    var qd = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new rd(a));
      }, b;
    }(_b),
        rd = function(a) {
          function b(b) {
          ...
          return bb(b, a), b.prototype.next = function(a) {
            ...
            this._o.onNext(Qb(a)), this._o.onCompleted();
          }, b.prototype.completed = function() {
            this._o.onNext(Rb()), this._o.onCompleted();
          }, b;
        }(Vb);
    Ub.materialize = function() {
      return new qd(this);
    }, Ub.repeat = function(a) {
      return fc(this, a).concat();
    }, Ub.retry = function(a) {
      return fc(this, a).catchError();
    }, Ub.retryWhen = function(a) {
    ...
    Ub.scan = function() {
      var a,
          b = !1,
          c = arguments[0];
      return 2 === arguments.length && (b = !0, a = arguments[1]), new sd(this, c, b, a);
    };
    var ud = function(a) {
      function b(b, c) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new vd(a, this._c));
      }, b;
    }(_b),
        vd = function(a) {
          function b(b, c) {
    ...
    Ub.skipLast = function(a) {
      if (0 > a)
        throw new ta;
      return new ud(this, a);
    }, Ub.startWith = function() {
      var a,
          b = 0;
      arguments.length && wb(arguments[0]) ? (a = arguments[0], b = 1) : a = Ab;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return hc([wc(c, a), this]).concat();
    };
    var wd = function(a) {
      function b(b, c) {
        this._o = b, this._c = c, this._q = [], a.call(this);
    ...
    Ub.takeLast = function(a) {
      if (0 > a)
        throw new ta;
      var b = this;
      return new Kd(function(c) {
        return b.subscribe(new wd(c, a));
      }, b);
    };
    var xd = function(a) {
      function b(b, c) {
    ...
    Ub.takeLastBuffer = function(a) {
      if (0 > a)
        throw new ta;
      var b = this;
      return new Kd(function(c) {
        return b.subscribe(new xd(c, a));
      }, b);
    }, Ub.windowWithCount = function(a, b) {
      var c = this;
      if (+a || (a = 0), Math.abs(a) === 1 / 0 && (a = 0), 0 >= a)
        throw new ta;
      if (null == b && (b = a), +b || (b = 0), Math.abs(b) === 1 / 0 && (b = 0), 0 >= b)
        throw new ta;
      return new Kd(function(d) {
        function e() {
          var a = new Nd;
          i.push(a), d.onNext(db(a, g));
        }
        var f = new ob,
            g = new sb(f),
            h = 0,
    ...
    }, Ub.flatMapConcat = Ub.concatMap = function(a, b, c) {
      return new ac(this, a, b, c).merge(1);
    }, Ub.concatMapObserver = Ub.selectConcatObserver = function(a, b, c, d) {
      var e = this,
          f = Ca(a, d, 2),
          g = Ca(b, d, 1),
          h = Ca(c, d, 0);
      return new Kd(function(a) {
        var b = 0;
        return e.subscribe(function(c) {
          ...
          ia(c) && (c = lc(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          ia(b) && (b = lc(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    };
    var yd = function(a) {
    ...
    Ub.defaultIfEmpty = function(b) {
      var c = this;
      return b === a && (b = null), new Kd(function(a) {
        return c.subscribe(new yd(a, b));
      }, c);
    ...
    var zd = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new Ad(a, this._keyFn, this._cmpFn));
      }, b;
    }(_b),
        Ad = function(a) {
          function b(b, c, d) {
          ...
          return bb(b, a), b.prototype.next = function(a) {
            var b = a;
            return ja(this._keyFn) && (b = la(this._keyFn)(a), b === ka) ? this._o.onError(b.e) : void(this._h.push(b) && this._o.onNext(a));
          }, b.prototype.error = function(a) {
            this._o.onError(a);
          }, b.prototype.completed = function() {
            this._o.onCompleted();
    ...
    Ub.distinct = function(a, b) {
      return b || (b = fa), new zd(this, a, b);
    };
    var Bd = function(a) {
      function b(b, c, d) {
      ...
      function d(a, b, c) {
        this.o = a, this.selector = b, this.source = c, this.i = 0, Vb.call(this);
      }
      return bb(b, a), b.prototype.internalMap = function(a, d) {
        ...
        var b = la(this.selector)(a, this.i++, this.source);
        return b === ka ? this.o.onError(b.e) : void this.o.onNext(b);
      }, d.prototype.error = function(a) {
        this.o.onError(a);
      }, d.prototype.completed = function() {
        this.o.onCompleted();
    ...
    Ub.map = Ub.select = function(a, b) {
      var c = "function" == typeof a ? a : function() {
        return a;
      };
      return this instanceof Bd ? this.internalMap(c, b) : new Bd(this, c, b);
    }, Ub.pluck = function() {
    ...
    }, Ub.flatMap = Ub.selectMany = function(a, b, c) {
      return new ac(this, a, b, c).mergeAll();
    }, Ub.flatMapObserver = Ub.selectManyObserver = function(a, b, c, d) {
      var e = this;
      return new Kd(function(f) {
        var g = 0;
        return e.subscribe(function(b) {
          ...
          ia(c) && (c = lc(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          ia(a) && (a = lc(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    ...
    var Dd = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Ed = function(a) {
          ...
          return bb(b, a), b.prototype.next = function(a) {
            if (!this._r) {
              var b = la(this._p._fn)(a, this._i++, this._p);
              if (b === ka)
                return this._o.onError(b.e);
              this._r = !b;
            }
    ...
    Ub.take = function(a, b) {
      if (0 > a)
        throw new ta;
      return 0 === a ? qc(b) : new Fd(this, a);
    };
    var Gd = function(a) {
      function b(b, c) {
        this.source = b, this._fn = c, a.call(this);
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new Hd(a, this));
      }, b;
    }(_b),
        Hd = function(a) {
          function b(b, c) {
    ...
    var Id = function(a) {
      ...
      function d(a, b, c) {
        this.o = a, this.predicate = b, this.source = c, this.i = 0, Vb.call(this);
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var b = la(this.predicate)(a, this.i++, this.source);
        return b === ka ? this.o.onError(b.e) : void(b && this.o.onNext(a));
      }, d.prototype.error = function(a) {
        this.o.onError(a);
      }, d.prototype.completed = function() {
        this.o.onCompleted();
    ...
    Ub.filter = Ub.where = function(a, b) {
      return this instanceof Id ? this.internalFilter(a, b) : new Id(this, a, b);
    };
    var Jd = function(a) {
      function b(b, c) {
      ...
      return bb(b, a), b.prototype.next = function(a) {
        var b = la(this._xform["@@transducer/step"]).call(this._xform, this._o, a);
        b === ka && this._o.onError(b.e);
      }, b.prototype.error = function(a) {
        this._o.onError(a);
      }, b.prototype.completed = function() {
    ...
    Ub.transduce = function(a) {
      var b = this;
      return new Kd(function(c) {
        var d = a(T(c));
        return b.subscribe(new Jd(c, d));
      }, b);
    };
    var Kd = ba.AnonymousObservable = function(a) {
      function b(a) {
        return a && ja(a.dispose) ? a : ja(a) ? jb(a) : kb;
      }
      function c(a, c) {
      ...
      return bb(d, a), d.prototype._subscribe = function(a) {
        ...
        Ld = function(a) {
          function b(b) {
            a.call(this), this.observer = b, this.m = new ob;
          }
          bb(b, a);
          var c = b.prototype;
          return c.next = function(a) {
            var b = la(this.observer.onNext).call(this.observer, a);
            b === ka && (this.dispose(), e(b.e));
          }, c.error = function(a) {
            var b = la(this.observer.onError).call(this.observer, a);
            this.dispose(), b === ka && e(b.e);
          }, c.completed = function() {
            var a = la(this.observer.onCompleted).call(this.observer);
            this.dispose(), a === ka && e(a.e);
    ...
    var Nd = ba.Subject = function(a) {
      function b() {
        a.call(this), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return bb(b, a), cb(b.prototype, Sb.prototype, {
        _subscribe: function(a) {
          return mb(this), this.isStopped ? this.hasError ? (a.onError(this.error), kb) : (a.onCompleted(), kb) : (this.observers.push(a), new Md(this, a));
        },
        ...
        Od = (ba.AsyncSubject = function(a) {
          function b() {
            a.call(this), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return bb(b, a), cb(b.prototype, Sb.prototype, {
            _subscribe: function(a) {
              return mb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), kb) : (this.observers.push(a), new Md(this, a));
            },
            hasObservers: function() {
        ...
        }($b), ba.AnonymousSubject = function(a) {
          function b(b, c) {
    ...
    "function" == typeof define && "object" == typeof define.amd && define.amd ? (aa.Rx = ba, define(function() {
      return ba;
    })) : V && W ? $ ? (W.exports = ba).Rx = ba : V.Rx = ba : aa.Rx = ba;
    var Pd = j();
  }).call(this);
})(require("process"));
