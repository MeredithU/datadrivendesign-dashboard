...
(function(process) {
  (function(a) {
    ...
    function D(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && A(b) ? (b = C(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > rc ? rc : b) : b;
    }
    function E(a, b) {
    ...
    var vb,
        ...
        zb = function(a) {
          ...
          return bb(c, a), c.prototype.schedule = function(a, c) {
            var f = new rb(this, a, c, this.now());
            if (d)
              d.enqueue(f);
            else {
              d = new Hb(4), d.enqueue(f);
              var g = la(b)();
              d = null, g === ka && e(g.e);
            }
            return f.disposable;
    ...
    !function() {
      ...
      if (ja(h))
        ...
        vb = "document" in aa && "onreadystatechange" in aa.document.createElement("script") ? function(b) {
        ...
        Gb = function(a) {
          ...
          return bb(b, a), b.prototype.schedule = function(a, b) {
            ...
            return function(c, d) {
              ...
              return f === ka ? (b._handler(f.e) || e(f.e), ib) : lb(ret);
            };
    ...
    Ib.isHigherPriority = function(a, b) {
      ...
      var b = this.length++;
      this.items[b] = new u(Hb.count++, a), this.percolate(b);
    ...
    var Jb = ba.Notification = function() {
      function a() {}
      return a.prototype._accept = function(a, b, c) {
        ...
        var b = this;
        return ub(a) || (a = yb), new Id(function(c) {
        ...
        Qb = ba.Observer = function() {};
    Qb.prototype.toNotifier = function() {
      var a = this;
      return function(b) {
        return b.accept(a);
      };
    ...
    var Sb,
        ...
        Zb = ba.ObservableBase = function(a) {
          ...
          return bb(d, a), d.prototype._subscribe = function(a) {
            var b = new Jd(a),
                d = [b, this];
            return Ab.scheduleRequired() ? Ab.schedule(d, c) : c(null, d), b;
        ...
        $b = ba.FlatMapObservable = function(a) {
          ...
          return bb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            return c === ka ? this.o.onError(c.e) : (ia(c) && (c = jc(c)), (Aa(c) || za(c)) && (c = Yb.from(c)), void this.o.onNext(this._wrapResult(c, a, b)));
        ...
        _b = ba.internals.Enumerable = function() {};
    ...
    _b.prototype.catchError = function() {
      return new bc(this);
        ...
        var d,
            ...
            l = Ab.scheduleRecursive(null, function(a, b) {
              if (!j.isDisposed) {
                ...
                var l = new mb,
                    m = new mb;
                k.setDisposable(new ob(m, l)), l.setDisposable(h.subscribe(function(a) {
                  c.onNext(a);
                }, function(a) {
    ...
    var lc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        var b = la(this._f)();
        return b === ka ? Fc(b.e).subscribe(a) : (ia(b) && (b = jc(b)), b.subscribe(a));
      }, b;
    }(Zb),
        mc = (Yb.defer = function(a) {
          ...
          return bb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            var a = this.observer;
            return this.scheduler === yb ? d(null, a) : this.scheduler.schedule(a, d);
          }, b;
        }(Zb)),
        nc = new mc(yb),
    ...
    Yb.generate = function(a, b, c, d, e) {
    ...
    var Dc = function(a) {
      ...
      function d(a, b) {
        var c = b[0],
            d = b[1];
        return d.onNext(c), d.onCompleted(), ib;
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Gc = function(a) {
          ...
          return bb(b, a), b.prototype.subscribeCore = function(a) {
            var b = ib,
                c = la(this._resFn)();
            if (c === ka)
              return new ob(Fc(c.e).subscribe(a), b);
            c && (b = c);
            var d = la(this._obsFn)(c);
            return d === ka ? new ob(Fc(d.e).subscribe(a), b) : new ob(d.subscribe(a), b);
          }, b;
        }(Zb);
    Yb.using = function(a, b) {
      return new Gc(a, b);
    }, Sb.amb = function(a) {
      var b = this;
      return new Id(function(c) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        for (var b = this._params.length,
          ...
          var f = this._params[e],
              g = new mb;
          c[e] = g, ia(f) && (f = jc(f)), g.setDisposable(f.subscribe(new Lc(a, e, this._cb, d)));
        }
        return new pb(c);
      }, b;
    }(Zb),
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Qc = function() {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new mb;
            this.g.add(c), ia(a) && (a = jc(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    Sc.prototype = Object.create(Error.prototype), Sc.prototype.name = "CompositeError";
    var Tc = function(a) {
      function b(b) {
        this.source = b, a.call(this);
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        return b.add(c), c.setDisposable(this.source.subscribe(new Uc(b, d))), b;
      }, b;
    }(Zb),
        Uc = function(a) {
          function b(b, c) {
          ...
          return bb(b, a), b.prototype.next = function(a) {
            var b = new mb;
            this._group.add(b), ia(a) && (a = jc(a)), b.setDisposable(a.subscribe(new d(b, this._group, this._state)));
          }, b.prototype.error = function(a) {
    ...
    var Vc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new mb;
          this.g.add(b), ia(a) && (a = jc(a)), b.setDisposable(a.subscribe(new d(this, b)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    var Wc = function(a) {
      ...
      function c(a, b) {
        if (a.pos < a.sources.length) {
          ...
          ia(c) && (c = jc(c));
          var d = new mb;
          a.subscription.setDisposable(d), d.setDisposable(c.subscribe(new Xc(a, b)));
        } else
          a.o.onCompleted();
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Zc = function(a) {
          ...
          return bb(b, a), b.prototype.subscribeCore = function(a) {
            var b = new mb;
            b.setDisposable(this._s.subscribe(new $c(a, this))), ia(this._o) && (this._o = jc(this._o));
            var c = new mb;
            return c.setDisposable(this._o.subscribe(new _c(a, this, c))), new ob(b, c);
          }, b;
        }(Zb),
        $c = function(a) {
          function b(b, c) {
    ...
    var ad = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var b = new mb,
            c = ++this.latest;
        this.hasLatest = !0, this.inner.setDisposable(b), ia(a) && (a = jc(a)), b.setDisposable(a.subscribe(new d(this, c)));
      }, c.prototype.error = function(a) {
        this.o.onError(a);
      }, c.prototype.completed = function() {
    ...
    Sb["switch"] = Sb.switchLatest = function() {
      return new ad(this);
    };
    var bd = function(a) {
      function b(b, c) {
    ...
    var dd = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        for (var b = this._ss.length,
          ...
          var g = this._ss[f],
              h = new mb;
          ia(g) && (g = jc(g)), h.setDisposable(g.subscribe(new ed(a, f, c))), e[f] = h;
        }
        var h = new mb;
        return h.setDisposable(this._s.subscribe(new fd(a, this._cb, c))), e[d] = h, new pb(e);
      }, b;
    }(Zb),
        ed = function(a) {
          function b(b, c, d) {
    ...
    Sb.withLatestFrom = function() {
      ...
      for (var a = arguments.length,
        ...
        b[c] = arguments[c];
      var d = ja(b[a - 1]) ? b.pop() : L;
      return Array.isArray(b[0]) && (b = b[0]), new dd(this, b, d);
    };
    var gd = function(a) {
      function b(b, c) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        for (var d = 0; b > d; d++) {
          var e = this._s[d],
              f = new mb;
          c[d] = f, ia(e) && (e = jc(e)), f.setDisposable(e.subscribe(new hd(a, d, this, q, done)));
        }
        return new pb(c);
      }, b;
    }(Zb),
    ...
    Sb.zip = function() {
      ...
      var d = ja(b[a - 1]) ? b.pop() : L,
          e = this;
      return b.unshift(e), new Id(function(a) {
        for (var c = b.length,
            f = r(c, M),
            g = r(c, K),
            h = new Array(c),
          ...
          !function(c) {
            var i = b[c],
                j = new mb;
            (Aa(i) || za(i)) && (i = sc(i)), j.setDisposable(i.subscribe(function(b) {
    ...
    Sb.distinctUntilChanged = function(a, b) {
    ...
    Sb["do"] = Sb.tap = Sb.doAction = function(a, b, c) {
      ...
      return new Id(function(c) {
        ...
        return d === ka ? (a(), e(d.e)) : hb(function() {
    ...
    Sb.scan = function() {
      var a,
          b = !1,
          c = arguments[0];
      return 2 === arguments.length && (b = !0, a = arguments[1]), new qd(this, c, b, a);
    };
    var sd = function(a) {
      function b(b, c) {
    ...
    Sb.skipLast = function(a) {
      ...
      var a,
          b = 0;
      arguments.length && ub(arguments[0]) ? (a = arguments[0], b = 1) : a = yb;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return fc([uc(c, a), this]).concat();
    };
    var ud = function(a) {
      function b(b, c) {
        this._o = b, this._c = c, this._q = [], a.call(this);
    ...
    Sb.defaultIfEmpty = function(b) {
      var c = this;
      return b === a && (b = null), new Id(function(a) {
    ...
    Sb.take = function(a, b) {
      if (0 > a)
        throw new ta;
      return 0 === a ? oc(b) : new Dd(this, a);
    };
    var Ed = function(a) {
      function b(b, c) {
        this.source = b, this._fn = c, a.call(this);
    ...
    Sb.filter = Sb.where = function(a, b) {
    ...
    Sb.transduce = function(a) {
      var b = this;
      return new Id(function(c) {
        var d = a(T(c));
        return b.subscribe(new Hd(c, d));
      }, b);
    };
    ...
    var Ld = ba.Subject = function(a) {
      ...
      return bb(b, a), cb(b.prototype, Qb.prototype, {
